...
int main()
{
    ...
    for (i = 0; i < symbols; ++i)
    {
        ...
        krlnc_encoder_set_const_symbol(
            encoder, i, input_symbols[i], symbol_size);
        ...
        krlnc_decoder_set_mutable_symbol(
            decoder, i, output_symbols[i], symbol_size);
    }
    ...
    for (i = 0; i < symbols; ++i)
    {
        ...
        krlnc_decoder_read_uncoded_symbol(decoder, input_symbols[i], i);
